...
export default function TaskBoard() {
    ...
    const [nextTaskId, setNextTaskId] = useState<number>(storedTasks.length ? storedTasks[storedTasks.length - 1].id + 1 : 1);
            ...
            <div className="mt-auto p-4">
                <form onSubmit={addTask} className="flex flex-col items-center">
                    ...
                    <input
                        ...
                        className="shadow-sm p-2 mb-4 rounded-lg w-full"
